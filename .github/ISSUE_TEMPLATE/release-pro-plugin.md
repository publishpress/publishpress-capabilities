...
- [ ] Update the reference for the `publishpress/publishpress-capabilities` package in the `lib/composer.json` file to use the recently released version tag (e.g., `4.7.0`) instead of a branch reference. This ensures the Pro plugin uses the stable release of the Free plugin.
...
- [ ] Monitor [GitHub Actions](https://github.com/publishpress/publishpress-capabilities-pro/actions)
